...
var data = [
    ...
    option = {
            ...
            title: {
                text: '世界各国现有确诊分布情况',
                subtext: '数据来源：今日头条',
                sublink:'https://i.snssdk.com/ugc/hotboard_fe/hot_list/template/hot_list/forum_tab.html?activeWidget=20&city_code=330100&city_name=%E6%9D%AD%E5%B7%9E',
                textStyle: {
                    color: '#ccc'
                },
                left: 'center',
            ...
            pieces: [{
                ...
                min: 10000,
                max: 100000,
                color: 'rgb(232, 103, 73)'
            }, {
                min: 5000,
                max: 9999,
                color: 'rgb(241, 131, 52)'
            }, {
                min: 500,
                max: 4999,
