var mytest = echarts.init(document.getElementById('test4'));
//跳转代码
mytest.on('click', function(params) {
...
option = {
    ...
    series: [{
        ...
        data: [
            ...
            {"url":"https:\\www.baidu.com","name": "乱港分子向中国大使馆求助", "value": 2226013, "symbolSize": 149, "draggable": true, "itemStyle": {"normal": { "shadowBlur": 100, "shadowColor": colorList[0], "color": colorList[0] } } },
            {"name": "吴春红要求道歉恢复名誉", "value": 1741162, "symbolSize": 131, "draggable": true, "itemStyle": {"normal": { "shadowBlur": 100, "shadowColor": colorList[1], "color": colorList[1] } } },
